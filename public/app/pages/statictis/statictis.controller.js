...
(function () {
  ...
  /** @ngInject */
  function statictisCtrl($element, baConfig, layoutPaths, $firebase) {
    ...
    var chartMoney = [];
    var date = new Date().getFullYear() + "/" + ((new Date().getMonth() + 1) > 10) ? (new Date().getMonth() + 1) : "0" + (new Date().getMonth() + 1);
